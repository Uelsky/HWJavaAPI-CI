# Домашнее задание к занятию «1.2. Тестирование API, CI» (Задачи 1-2) [![Build status](https://ci.appveyor.com/api/projects/status/5guthmdo19nqyfj3?svg=true)](https://ci.appveyor.com/project/Uelsky/hwjavaapi-ci)
...
Ваш целевой сервис (SUT — System under test), расположен в файле [app-mbank.jar](artifacts/app-mbank.jar), этот же файл используется в примерах на лекции. Вам нужно его положить в каталог `artifacts` вашего проекта, который необходимо создать.
